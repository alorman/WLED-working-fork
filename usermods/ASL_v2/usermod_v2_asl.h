...
class usermod_v2_ASL : public Usermod {
  private:
    ...
    uint32_t StationRed = 65280;
    uint32_t TrainRed = 16711680;
  ...
  void PlotLEDStations(uint32_t LEDArrayToPlot[], uint16_t StationArray[], uint16_t NumStations, uint32_t StationColor, uint32_t TrackColor)
  {
