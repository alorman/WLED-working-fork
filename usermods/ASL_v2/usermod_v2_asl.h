...
//Blue Line
uint16_t BlueLineTrack1Domains [][2] = { {2605,2633},{2635,2673},{967 , 975},{ 977,1009},{1011,1023},{1025,1035},{1037,1051},{1053,1069},{1071,1091},{1093,1104},{1106,1116},{1118,1125},{1127,1134},{1378,1383},{1385,1392},{1394,1399},{1401,1405},{1407,1417},{1419,1423},{1425,1435},{1437,1460},{2409,2419},{2421,2433},{2435,2448},{2450,2468},{2470,2486} };
uint16_t BlueLineTrack2Domains [][2] = { {2680,2708},{2710,2752},{1160,1169},{1171,1203},{1205,1216},{1218,1229},{1231,1245},{1247,1264},{1266,1284},{1286,1297},{1299,1309},{1311,1322},{1324,1329},{1544,1548},{1550,1558},{1560,1567},{1569,1574},{1576,1589},{1591,1597},{1599,1609},{1611,1634},{2495,2505},{2507,2520},{2522,2536},{2538,2556},{2558,2573} };
...
//Orange Line
uint16_t OrangeLineTrack1Domains [][2] = { {2755,2795},{2797,2816},{2818,2843},{2845,2869},{2871,2885},{2887,2897},{2899,2910},{2912,2927},{1090,1104},{1106,1116},{1118,1125},{1127,1134},{1383,1378},{1385,1392},{1394,1399},{1401,1405},{1407,1417},{1419,1423},{1425,1435},{1437,1442},{1444,1474},{1476,1486},{1488,1499},{1501,1521},{1523,1541} };
uint16_t OrangeLineTrack2Domains [][2] = { {2934,2953},{2955,2975},{2977,3000},{3002,3022},{3024,3036},{3038,3047},{3049,3060},{3062,3075},{1283,1297},{1299,1309},{1311,1322},{1324,1329},{1544,1548},{1550,1558},{1560,1567},{1569,1574},{1576,1589},{1591,1597},{1599,1609},{1611,1617},{1619,1642},{1644,1656},{1658,1669},{1671,1691},{1693,1710} };
...
uint16_t OrangeLineTrack1StationSegments[] = {2774,2796,2817,2844,2870,2886,2898,2911,1089,1105,1117,1126,1135,1400,1406,1418,1424,1436,1443,1475,1487,1500,1522,1542};  
uint16_t OrangeLineTrack2StationSegments[] = {2933,2954,2976,3001,3023,3037,3048,3061,1282,1298,1310,1323,1330,1568,1575,1590,1598,1610,1618,1643,1657,1670,1692,1711};

//Yellow Line
uint16_t YellowLineTrack1Domains [][2] = { { 945, 954},{ 956, 965},{ 967, 975},{ 977,1009},{1011,1023},{1025,1035},{1037,1053},{3124,3145},{2363,2375},{2377,2380},{1900,1910},{1912,1922},{1924,1931},{1933,1941},{1943,1955},{1957,1970} };
uint16_t YellowLineTrack2Domains [][2] = { {1138,1147},{1149,1161},{1163,1169},{1171,1203},{1205,1216},{1218,1229},{1231,1247},{3105,3123},{2230,2240},{2242,2245},{1744,1752},{1754,1763},{1765,1772},{1774,1781},{1783,1795},{1797,1808} };
...
uint16_t BlueLineLEDArray [][2] = { {1,22},{24,55},{57,61},{63,71},{73,81},{83,91},{93,100},{102,120},{122,148},{150,167},{169,177},{179,187},{189,194},{196,199},{201,205},{207,223},{225,229},{231,235},{237,244},{246,250},{252,255},{257,266},{268,277},{279,283},{285,289},{291,296} };
...
uint16_t BlueTrack2PositionCounter = BlueLineTrack2SegmentCount;

uint16_t GreenTrack1PositionCounter = 0;
uint16_t GreenTrack2PositionCounter = GreenLineTrack2SegmentCount;

uint16_t OrangeTrack1PositionCounter = 0;
uint16_t OrangeTrack2PositionCounter = OrangeLineTrack2SegmentCount;
